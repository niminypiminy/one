    ...
    <>
      <div className="home-container">
        ...
        <section className="home-mission">
          <img
            alt="image"
            src="/coffeedrinkinglawyer2-1200h.jpg"
            loading="eager"
          ...
          <div className="home-container07">
            ...
            <Link href="/accounting-services">
              <a className="home-link06">
                <h1 className="home-accounting-services">
                  Accounting Services
                </h1>
              </a>
            </Link>
                  ...
                  <div className="home-practice-wrapper1">
                    <Link href="/property-law">
                      <a>
                        <Practice
                          Title="Property"
                          Description="Ownership and transfer of land, real estate, and other property, both real and intangible."
                  ...
                  <div className="home-practice-wrapper2">
                    <Link href="/tax-law">
                      <a>
                        <Practice
                          Title="Tax"
                          Description="Regulatory tax compliance, auditing, establishment of trusts, annual reports, and adjudication"
      ...
      <style jsx>
        {`
          ...
          .home-accounting-services:hover {
            border-color: #ffff00;
            border-width: 1px;
            border-top-width: 0px;
            border-left-width: 0px;
