        ...
        <div className="faq8-max-width thq-section-max-width thq-flex-column">
          <div className="faq8-section-title thq-flex-column">
            <div className="faq8-content">
              ...
              <p className="faq8-text01 thq-body-large">{props.text1}</p>
            </div>
          </div>
          <div className="faq8-list thq-flex-column">
            <div className="faq8-faq1 thq-section-max-width thq-box-shadow">
              <div className="faq8-trigger">
                <p className="faq8-faq1-question thq-body-large">
                  {props.faq1Question}
                </p>
                <div className="faq8-icons-container">
                  <div>
                    <svg viewBox="0 0 1024 1024" className="faq8-icon">
                      <path d="M213.333 554.667h256v256c0 23.552 19.115 42.667 42.667 42.667s42.667-19.115 42.667-42.667v-256h256c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-256v-256c0-23.552-19.115-42.667-42.667-42.667s-42.667 19.115-42.667 42.667v256h-256c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
                    </svg>
                  </div>
                  <div>
                    <svg viewBox="0 0 1024 1024" className="faq8-icon02">
                      <path d="M213.333 554.667h597.333c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-597.333c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
                    </svg>
                  </div>
                </div>
              </div>
              <div className="faq8-container02">
                <span className="faq8-text02 thq-body-small">
                  <span>
                  ...
                  <Link href="/contact">
                    <a className="faq8-link">contact</a>
                  </Link>
                  <span> us for a brief consultation.</span>
                </span>
              </div>
            </div>
            <div className="faq8-faq2 thq-section-max-width thq-box-shadow">
              <div className="faq8-trigger1">
                <p className="faq8-faq2-question thq-body-large">
                  {props.faq2Question}
                </p>
                <div className="faq8-icons-container1">
                  <div>
                    <svg viewBox="0 0 1024 1024" className="faq8-icon04">
                      <path d="M213.333 554.667h256v256c0 23.552 19.115 42.667 42.667 42.667s42.667-19.115 42.667-42.667v-256h256c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-256v-256c0-23.552-19.115-42.667-42.667-42.667s-42.667 19.115-42.667 42.667v256h-256c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
                    </svg>
                  </div>
                  <div>
                    <svg viewBox="0 0 1024 1024" className="faq8-icon06">
                      <path d="M213.333 554.667h597.333c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-597.333c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
                    </svg>
                  </div>
                </div>
              </div>
              <div className="faq8-container05">
                <span className="faq8-text05 thq-body-small">
                  {props.text2}
                </span>
              </div>
            </div>
            <div className="faq8-faq3 thq-section-max-width thq-box-shadow">
              <div className="faq8-trigger2">
                <p className="faq8-faq2-question1 thq-body-large">
                  {props.faq2Question1}
                </p>
                <div className="faq8-icons-container2">
                  <div>
                    <svg viewBox="0 0 1024 1024" className="faq8-icon08">
                      <path d="M213.333 554.667h256v256c0 23.552 19.115 42.667 42.667 42.667s42.667-19.115 42.667-42.667v-256h256c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-256v-256c0-23.552-19.115-42.667-42.667-42.667s-42.667 19.115-42.667 42.667v256h-256c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
                    </svg>
                  </div>
                  <div>
              ...
              <div className="faq8-container08">
                <span className="faq8-text06 thq-body-small">
                  <span>
                    Yes. Please
                    <span
                      dangerouslySetInnerHTML={{
                  ...
                  <Link href="/contact">
                    <a className="faq8-link1">contact</a>
                  </Link>
                  <span>
                    {' '}
            ...
            <div className="faq8-faq4 thq-section-max-width thq-box-shadow">
              <div className="faq8-trigger3">
              ...
              <div className="faq8-container11">
                <span className="faq8-text09 thq-body-small">
                  {props.text3}
                </span>
              </div>
            </div>
            <div className="faq8-faq41 thq-section-max-width thq-box-shadow">
              <div className="faq8-trigger4">
                <p className="faq8-faq2-question3 thq-body-large">
                  {props.faq2Question3}
                </p>
                <div className="faq8-icons-container4">
                  <div>
              ...
              <div className="faq8-container14">
                <span className="faq8-text10 thq-body-small">
                  <span>
                  ...
                  <Link href="/online-fraud">
                    <a className="faq8-link2">fraud</a>
                  </Link>
                  <span>
