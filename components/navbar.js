        ...
        <div className="navbar-container1">
          <header data-thq="thq-navbar" className="navbar-navbar-interactive">
            <div className="navbar-branding">
              ...
              <span className="navbar-text">{props.lawfirm2}</span>
            </div>
            <div
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <span className="navbar-tax-law">{props.Tax_Law}</span>
                      </div>
                    </li>
                  </ul>
                </div>
            ...
            <div data-thq="thq-mobile-menu" className="navbar-mobile-menu">
              ...
              <nav className="navbar-links1">
                    ...
                    >
                      <Link href="/tax-law">
                        <a>
                          ...
                          >
                            <span className="navbar-text08">{props.tax}</span>
                          </div>
                        </a>
                      </Link>
                    </li>
                ...
                >
                  ...
                  >
                    <span className="navbar-text12">Immigration Visas</span>
                    <div
                      data-thq="thq-dropdown-arrow"
                    ...
                    >
                      <Link href="/work-permit">
                        <a>
                          ...
                          >
                            <span className="navbar-text14">Work Permit</span>
                          </div>
                        </a>
                      </Link>
                    </li>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <Link href="/branch-office">
                          <a className="navbar-link16">{props.branch_office}</a>
                        </Link>
                      </div>
                    </li>
                    <li
                        ...
                        <a>
                          ...
                          >
                            <span className="navbar-text21">
                              {props.Foreign_business_license}
                            </span>
                          </div>
                        </a>
                      </Link>
                    ...
                    <li
                      data-thq="thq-dropdown"
                      className="navbar-dropdown21 list-item"
                    >
                      <Link href="/thai-australia-free-trade-agreement">
                        <a>
                          <div
                            data-thq="thq-dropdown-toggle"
                            className="navbar-dropdown-toggle24"
                          >
                            <span className="navbar-text22">{props.tafta}</span>
                          </div>
                        </a>
                      </Link>
                    </li>
                    <li
                      data-thq="thq-dropdown"
                      className="navbar-dropdown22 list-item"
                    >
                      <Link href="/japan-thailand-economic-partnership-agreement">
                        <a>
                          <div
                            data-thq="thq-dropdown-toggle"
                            className="navbar-dropdown-toggle25"
                          >
                            <span className="navbar-text23">{props.jtepa}</span>
                          </div>
                        </a>
                      </Link>
                    </li>
                ...
                <span className="navbar-text24">{props.Insights}</span>
                <Link href="/pro-bono">
                  <a className="navbar-link22">{props.Pro_bono}</a>
                </Link>
              </nav>
              <div className="navbar-social-bar">
                <div className="navbar-container2">
                  <span className="navbar-text25">{props.telegram}</span>
                </div>
                <span className="navbar-text26">{props.whatsapp}</span>
                <span className="navbar-text27">{props.facebook}</span>
                <span className="navbar-text28">{props.line}</span>
              </div>
            </div>
          </header>
        </div>
...
Navbar.defaultProps = {
  ...
  Foreign_business_license: 'Foreign Business License',
  Immigration: 'Immigration ',
  telegram: 'Telegram',
  Hamburger_src: '/hamburger.svg',
  Immigration_Law: 'Immigration Law',
  Corporate_Law: 'Contract Law',
  line: 'LINE',
  register_your_company: 'Company Registration',
  rootClassName: '',
  Hamburger_alt: 'image',
  Tax_Law: 'Tax Law',
  ...
  jtepa: 'JTEPA',
  cri: 'Criminal ',
  treaty_of_amity: 'U.S. Thailand Treaty of Amity',
  corporate: 'Corporate ',
  limitedcompany: 'Limited Company (Ltd)',
  public: 'Public ',
  board_of_investment: 'Board of Investment (BOI)',
  contact: 'Contact',
...
Navbar.propTypes = {
  ...
  Pro_bono: PropTypes.string,
  danneskiold2: PropTypes.string,
  Insights: PropTypes.string,
  branch_office: PropTypes.string,
  Danneskiold: PropTypes.string,
  Foreign_business_license: PropTypes.string,
  Immigration: PropTypes.string,
  telegram: PropTypes.string,
  Hamburger_src: PropTypes.string,
  Immigration_Law: PropTypes.string,
  Corporate_Law: PropTypes.string,
  line: PropTypes.string,
  register_your_company: PropTypes.string,
  rootClassName: PropTypes.string,
  Hamburger_alt: PropTypes.string,
  Tax_Law: PropTypes.string,
  text1411: PropTypes.string,
  limited_partnership: PropTypes.string,
  rep_office: PropTypes.string,
  lawfirm: PropTypes.string,
  lawfirm2: PropTypes.string,
  Criminal_Law: PropTypes.string,
  whatsapp: PropTypes.string,
  jtepa: PropTypes.string,
  cri: PropTypes.string,
  treaty_of_amity: PropTypes.string,
  corporate: PropTypes.string,
  limitedcompany: PropTypes.string,
  public: PropTypes.string,
  board_of_investment: PropTypes.string,
