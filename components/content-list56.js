...
const ContentList56 = (props) => {
  const [isTermsVisible, setIsTermsVisible] = useState(true)
  const [isRefundVisible, setIsRefundVisible] = useState(false)
  const [isPrivacyVisible, setIsPrivacyVisible] = useState(false)
  return (
    <>
      <div className="content-list56-container thq-section-padding">
        <div className="content-list56-max-width thq-section-max-width thq-flex-column">
          <div className="content-list56-container1 thq-section-max-width thq-flex-row">
            {isTermsVisible && (
              <button
                onClick={() => {
          ...
          <div className="content-list56-container2 thq-flex-column">
            {isTermsVisible && (
              <div className="content-list56-container3">
                <ul className="thq-flex-column">
                  <li className="thq-flex-column list-item">
                    <h2 className="content-list56-heading7 thq-heading-2">
                      {props.heading7}
                    </h2>
                    <p className="thq-body-small">{props.content7}</p>
                    <ul className="content-list56-ul1 thq-flex-column">
            ...
            {isPrivacyVisible && (
              <div className="content-list56-container4">
                <ul className="thq-flex-column">
                  <li className="thq-flex-column list-item">
                    <h1 className="content-list56-heading1 thq-heading-2">
                      {props.heading1}
                    </h1>
                    <span className="thq-body-small">{props.content1}</span>
                    <ul className="content-list56-ul3 thq-flex-column">
                      <li className="thq-flex-column list-item">
            ...
            {isRefundVisible && (
              <div className="content-list56-container5">
                <ul className="thq-flex-column">
                  <li className="thq-flex-column list-item">
                    <h1 className="content-list56-heading10 thq-heading-2">
                      {props.heading10}
                    </h1>
                    <span className="thq-body-small">{props.content10}</span>
                    <ul className="content-list56-ul5 thq-flex-column">
                      <li className="list-item">
      ...
      <style jsx>
        {`
          ...
          .content-list56-container3 {
            align-self: stretch;
            align-items: flex-start;
          }
          .content-list56-heading7 {
            text-align: center;
          }
          .content-list56-ul1 {
            padding-left: var(--dl-space-space-fiveunits);
          }
          .content-list56-container4 {
            align-self: stretch;
            align-items: flex-start;
          }
          .content-list56-heading1 {
            text-align: center;
          }
          .content-list56-ul3 {
            padding-left: var(--dl-space-space-fiveunits);
          }
          .content-list56-container5 {
            align-self: stretch;
            align-items: flex-start;
          }
          .content-list56-heading10 {
            text-align: center;
          }
          .content-list56-ul5 {
            padding-left: var(--dl-space-space-fiveunits);
