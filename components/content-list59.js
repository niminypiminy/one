...
const ContentList59 = (props) => {
  const [isPrivacyVisible, setIsPrivacyVisible] = useState(false)
  const [isRefundVisible, setIsRefundVisible] = useState(false)
  const [isTermsVisible, setIsTermsVisible] = useState(true)
  return (
    <>
      <div className="content-list59-container thq-section-padding">
        <div className="content-list59-max-width thq-section-max-width thq-flex-column">
          <div className="content-list59-container1 thq-section-max-width thq-flex-row">
            {isTermsVisible && (
              <button
                onClick={() => {
          ...
          <div className="content-list59-container2 thq-flex-column">
            {isTermsVisible && (
              <div className="content-list59-container3">
                <ul className="thq-flex-column">
                  <li className="thq-flex-column list-item">
                    <h2 className="content-list59-heading7 thq-heading-2">
                      {props.heading7}
                    </h2>
                    <p className="thq-body-small">{props.content7}</p>
                    <ul className="content-list59-ul1 thq-flex-column">
            ...
            {isPrivacyVisible && (
              <div className="content-list59-container4">
                <ul className="thq-flex-column">
                  <li className="thq-flex-column list-item">
                    <h1 className="content-list59-heading1 thq-heading-2">
                      {props.heading1}
                    </h1>
                    <span className="thq-body-small">{props.content1}</span>
                    <ul className="content-list59-ul3 thq-flex-column">
                      <li className="thq-flex-column list-item">
            ...
            {isRefundVisible && (
              <div className="content-list59-container5">
                <ul className="thq-flex-column">
                  <li className="thq-flex-column list-item">
                    <h1 className="content-list59-heading10 thq-heading-2">
                      {props.heading10}
                    </h1>
                    <span className="thq-body-small">{props.content10}</span>
                    <ul className="content-list59-ul5 thq-flex-column">
                      <li className="list-item">
      ...
      <style jsx>
        {`
          ...
          .content-list59-container3 {
            align-self: stretch;
            align-items: flex-start;
          }
          .content-list59-heading7 {
            text-align: center;
          }
          .content-list59-ul1 {
            padding-left: var(--dl-space-space-fiveunits);
          }
          .content-list59-container4 {
            align-self: stretch;
            align-items: flex-start;
          }
          .content-list59-heading1 {
            text-align: center;
          }
          .content-list59-ul3 {
            padding-left: var(--dl-space-space-fiveunits);
          }
          .content-list59-container5 {
            align-self: stretch;
            align-items: flex-start;
          }
          .content-list59-heading10 {
            text-align: center;
          }
          .content-list59-ul5 {
            padding-left: var(--dl-space-space-fiveunits);
