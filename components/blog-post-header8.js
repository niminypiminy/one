    ...
    <>
        ...
        <div className="blog-post-header8-max-width thq-section-max-width">
          <div className="blog-post-header8-content thq-flex-column">
            ...
            <div className="blog-post-header8-share-buttons thq-flex-row">
              ...
              <button className="blog-post-header8-share-button2 thq-button-icon thq-button-filled">
                <svg
      ...
      <style jsx>
        {`
          ...
          .blog-post-header8-author-name {
            font-size: 32px;
            align-self: flex-start;
            text-align: left;
            font-weight: 200;
          }
          .blog-post-header8-share-buttons {
            align-self: flex-start;
          }
          .blog-post-header8-share-button2 {
